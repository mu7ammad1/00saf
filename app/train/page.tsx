...
export default function GenerateImageScreen() {
  return (
    <main className="w-full">
      <h1 className={title()}>We&apos;re still building this page.</h1>
      <div className="hidden flex-col items-center justify-center gap-4 py-8 md:py-10">
        <DropdownComponenet />
      </div>
      ...
      <Card className="hidden max-w-2xl w-full mx-auto fixed bottom-3 max-sm:bottom-0 left-0 right-0 z-10">
